...
static void OneU4(const RsExpandKernelDriverInfo *info, uint32_t x, uchar4 *out,
                  const uchar4 *py0, const uchar4 *py1, const uchar4 *py2, const uchar4 *py3,
                  const uchar4 *py4, const float* coeff) {
...
static void OneU2(const RsExpandKernelDriverInfo *info, uint32_t x, uchar2 *out,
                  const uchar2 *py0, const uchar2 *py1, const uchar2 *py2, const uchar2 *py3,
                  const uchar2 *py4, const float* coeff) {
...
static void OneU1(const RsExpandKernelDriverInfo *info, uint32_t x, uchar *out,
                  const uchar *py0, const uchar *py1, const uchar *py2, const uchar *py3,
                  const uchar *py4, const float* coeff) {
...
static void OneF4(const RsExpandKernelDriverInfo *info, uint32_t x, float4 *out,
                  const float4 *py0, const float4 *py1, const float4 *py2, const float4 *py3,
                  const float4 *py4, const float* coeff) {
...
static void OneF2(const RsExpandKernelDriverInfo *info, uint32_t x, float2 *out,
                  const float2 *py0, const float2 *py1, const float2 *py2, const float2 *py3,
                  const float2 *py4, const float* coeff) {
...
static void OneF1(const RsExpandKernelDriverInfo *info, uint32_t x, float *out,
                  const float *py0, const float *py1, const float *py2, const float *py3,
                  const float *py4, const float* coeff) {
